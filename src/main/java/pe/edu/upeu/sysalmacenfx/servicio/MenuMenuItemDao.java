...
public class MenuMenuItemDao implements MenuMenuItenDaoI {
    ...
    public List<MenuMenuItenTO> listaAccesos(String perfil, Properties idioma) {
        ...
        lista.add(new MenuMenuItenTO("Producto", "Reg. Genero", "mireggenero"));
        lista.add(new MenuMenuItenTO("Producto", "Reg. Actor", "miregactor"));
        lista.add(new MenuMenuItenTO("Producto", "Reg. Pelicula", "miregpelicula"));
